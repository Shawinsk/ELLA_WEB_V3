...
try:
    ...
    print("[WEB] Warning: playwright not installed. Web features disabled.")
...
class WebAgent:
    ...
    async def run_task(self, prompt, update_callback=None):
        ...
        if not async_playwright:
             print("[WEB AGENT] Playwright unavailable.")
             return "Web Agent disabled (playwright not installed)."
